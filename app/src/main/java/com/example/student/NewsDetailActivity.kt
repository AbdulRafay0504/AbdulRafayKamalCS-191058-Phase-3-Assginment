...
import com.example.student.databinding.ActivityNewsDetailsBinding
...
class NewsDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val publishingDetails = "${news?.author ?: "Anonymous"} at ${(news?.publishedAt?.let {
            SimpleDateFormat("dd MMM yyyy, HH:mm:ss ").format(
                it
            )
        })}"
